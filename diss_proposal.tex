...
\begin{figure}%
    \centering
    \subfloat[\centering Task Design]{{\includegraphics[width=7cm]{figures/aim_1_task.png} }}%
    \qquad
    \subfloat[\centering Hippocampal Subfields and Results]{{\includegraphics[width=7cm]{figures/aim_1_results.png} }}%
